...
1.0\\
  ...
  \footnotetext[8]{Non-negative slope detected in linear regression and fraction of infectious reach 1.0 periodically}
  \footnotetext[9]{infectious fraction reach 1.0 at \(t=11\) in average}
 ...
 0.99928& 0.99971&  0.99985& 0.99992& 1.0000\\
  ...
  \footnotetext[12]{Non-negative slope detected in linear regression of data and fraction of infectious reach 1.0 periodically}
  \footnotetext[13]{infectious fraction reach 1.0 at \(t=11\) in average}
...
0.99731 \\
  ...
  \begin{adjustbox}{max width=1.2\textwidth,center}
    ...
    \end{tabular}
  \end{adjustbox}
  \footnotetext[15]{Linear regression used due to the large s.d. of time and magnitude of peaks}
  \footnotetext[16]{0.88 fraction of simulations terminates}
  \footnotetext{r=6 to r=10 have all simulations terminates without second peak arising}
